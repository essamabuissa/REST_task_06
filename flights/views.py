...
from .permissions import OwnerOrAdminBooker , CannotCancelOrUpdate
...
class BookingDetails(RetrieveAPIView):
	...
	permission_classes = [OwnerOrAdminBooker]
...
class UpdateBooking(RetrieveUpdateAPIView):
	...
	lookup_field = 'id'
	lookup_url_kwarg = 'booking_id'
	permission_classes = [OwnerOrAdminBooker , CannotCancelOrUpdate]
